...
export type ClientSignal =
  ...
  | { type: 'sdp'; roomId: string; sdp: SdpMessage }
  | { type: 'ice'; roomId: string; candidate: IceCandidateMessage }
  | { type: 'leave' };
...
export type ServerSignal =
  ...
  | { type: 'sdp'; from: Role; peerId: string; sdp: SdpMessage }
  | { type: 'ice'; from: Role; peerId: string; candidate: IceCandidateMessage }
